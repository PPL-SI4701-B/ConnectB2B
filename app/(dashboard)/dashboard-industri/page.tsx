    ...
    <div className="w-full bg-bg-color min-h-screen">
      ...
      <div className="bg-card-bg rounded-xl shadow-sm overflow-hidden p-[30px] min-h-[400px]">
        <div className="flex justify-between items-center mb-[25px]">
          ...
          <Link href="/dashboard-industri/transaksi" className="text-text-main bg-transparent border border-border-color px-5 py-2.5 rounded-lg font-semibold text-[15px] flex items-center hover:bg-bg-color transition-colors">
